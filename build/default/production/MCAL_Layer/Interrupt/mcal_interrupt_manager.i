...
# 19 "MCAL_Layer/Interrupt/mcal_interrupt_config.h" 2
...
void __attribute__((picinterrupt(("")))) General_Interrupt_Manager(void){
...
# 60 "MCAL_Layer/Interrupt/mcal_interrupt_manager.c"
    if((1==INTCONbits.RBIE) && (1==INTCONbits.RBIF) && (PORTBbits.RB4==GPIO_STATE_HIGH)
            &&(RB4_Flag==1))
    {
        RB4_Flag=0;
        RB4_ISR(1);
    ...
    if((1==INTCONbits.RBIE) && (1==INTCONbits.RBIF)&& (PORTBbits.RB4==GPIO_STATE_LOW)
            &&(RB4_Flag==0))
    {
        RB4_Flag=1;
        RB4_ISR(0);
    ...
    if((1==INTCONbits.RBIE) && (1==INTCONbits.RBIF) && (PORTBbits.RB5==GPIO_STATE_HIGH)
            &&(RB5_Flag==1)){
        RB5_Flag=0;
        RB5_ISR(1);
    ...
    if((1==INTCONbits.RBIE) && (1==INTCONbits.RBIF) && (PORTBbits.RB5==GPIO_STATE_LOW)
            &&(RB5_Flag==0)){
        RB5_Flag=1;
        RB5_ISR(0);
    ...
    if((1==INTCONbits.RBIE) && (1==INTCONbits.RBIF) && (PORTBbits.RB6==GPIO_STATE_HIGH)
            &&(RB6_Flag==1)){
        RB6_Flag=0;
        RB6_ISR(1);
    ...
    if((1==INTCONbits.RBIE) && (1==INTCONbits.RBIF) && (PORTBbits.RB6==GPIO_STATE_LOW)
            &&(RB6_Flag==0)){
        RB6_Flag=1;
        RB6_ISR(0);
    ...
    if((1==INTCONbits.RBIE) && (1==INTCONbits.RBIF) && (PORTBbits.RB7==GPIO_STATE_HIGH)
            &&(RB7_Flag==1)){
        RB7_Flag=0;
        RB7_ISR(1);
    ...
    if((1==INTCONbits.RBIE) && (1==INTCONbits.RBIF) && (PORTBbits.RB7==GPIO_STATE_LOW)
            &&(RB7_Flag==0)){
        RB7_Flag=1;
        RB7_ISR(0);
